package com.zxl.daily.base.designpattern.hanshunping.principle.segregation.improve;
...
class B implements Interface1,Interface2 {
	public void operation1() {System.out.println("B 实现了 operaiton1");}
...
class A {//A 类通过接口Interface1,Interface2 依赖（使用） B类，但是只用到了1,2,3方法
...
class C {//C 类通过接口Interface1，Interface3 依赖（使用）D类，但是只是用了1,4,5方法
	public void depend1(Interface1 i) {i.operation1();}
